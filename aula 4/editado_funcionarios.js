...
async function editar() {
    ...
    try {
        ...
        console.log("\nRegistro encontrado:");
        console.log(`Nome do funcionário atual: ${registro.nome}`);
        console.log(`Gênero do funcionário atual: ${registro.genero}`);
        ...
        console.log("\nErro ao editar funcionário:", erro.message);
    }
}
